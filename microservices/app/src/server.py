...
def directions(client, origin, destination,
               ...
               language, units, region, departure_time,
               arrival_time, optimize_waypoints, transit_mode
               transit_routing_preference, traffic_model):
			   gmaps = googlemaps.Client(key='AIzaSyD4vFeHr-QHY6oRPcMZ-fjfU2W3utQfs0w')
    ...
    return client._request("/maps/api/directions/json", params).get("routes", [])a new URL at /new
